//<![CDATA[
/**
 * Modif Author Url 	: http://irvan-efendy.blogspot.com/
 */

var rp_homePage    = "http://"+window.location.hostname+"", // Your blog homepage
    rp_numPosts    = 5, // How many posts?
    rp_thumbWidth  = 30, // Thumbnail width. Change to 0 if you want to disable the post thumbnail
    ...
    rp_noImage     = "http://3.bp.blogspot.com/-MzMilqmiIbQ/UUPfgxyHP5I/AAAAAAAACRc/w-HMiiF_LuY/s30/faceblogSM-nogambar.jpg", // A 'no-image' image
    rp_monthNames  = [
        "Januari",
        "Februari",
        "Maret",
...
function showRecentPosts(json) {
    ...
    for (var i = 0; i < rp_numPosts; i++) {
        ...
        skeleton += '</li>';
        document.getElementById('SM_recent-post').innerHTML += skeleton;
    }
